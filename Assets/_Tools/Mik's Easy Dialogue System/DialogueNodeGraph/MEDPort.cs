...
namespace GetMikyled.MEDialogue
{
  ///-//////////////////////////////////////////////////////////////////
  ///
  public class MEDPort : Port
  {
    public string GUID;

    ///-//////////////////////////////////////////////////////////////////
    ///
    public MEDPort(Orientation orientation, Direction direction, Capacity capcity, Type type) :
      base(orientation, direction, capcity, type)
    {
      EdgeConnectionListener listener = new EdgeConnectionListener();
  ...
  ///-//////////////////////////////////////////////////////////////////
  ///
  /// DISCLAIMER: Copied from NodeGraphView's
  /// Port.DefaultEdgeConnectionListener in order to support
  /// the custom port class
  ///
